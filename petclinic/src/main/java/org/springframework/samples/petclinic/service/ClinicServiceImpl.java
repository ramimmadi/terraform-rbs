...
public class ClinicServiceImpl implements ClinicService {
    ...
    @Autowired
    public ClinicServiceImpl(PetRepository petRepository, AppointmentRepository appointmentRepository,VetRepository vetRepository, OwnerRepository ownerRepository, VisitRepository visitRepository) {
